...
/*******************************************************************************
 * This {@code Action} automatically imports the current mesh input file.  It
 * then checks if the nodes and node key groups that were just imported have the
 * same names.  If the check is {@code false}, it displays a warning to the
 * user.
 * 
 * @author  Adam C. Dick, BSE
 * @version September 13, 2008
 ******************************************************************************/
public class MeshReadAction extends AbstractAction {
     ...
     *                      for
     **************************************************************************/
    public MeshReadAction(JMeshPanel meshPanel, DefaultMeshUI meshUI) {
        super("Open...");
