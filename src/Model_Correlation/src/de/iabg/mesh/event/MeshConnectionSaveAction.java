 ...
 * node connections.  If this is {@code true}, it automatically retrieves the
 * node connection and exports it to the current node connection output file.
 * If the check is {@code false}, it displays an error to the user.
 * 
 * @author  Adam C. Dick, BSE
 * @version September 13, 2008
 ******************************************************************************/
public class MeshConnectionSaveAction extends AbstractAction {
     ...
     *                          is designed for
     **************************************************************************/
    public MeshConnectionSaveAction(JMeshConnectionPanel connectionPanel,
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        try {
            if (connectionPanel_.isConnected()) {
                fileName = connectionUI_.getConnectionOutput();
                if (fileName != null) {
