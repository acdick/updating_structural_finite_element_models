 ...
 * mode connections.  If this is {@code true}, it opens a dialog for the user to
 * select the mode connection output file and then exports it.  If the check is
 * {@code false}, it displays an error to the user.
 * 
 * @author  Adam C. Dick, BSE
 * @version September 14, 2008
 ******************************************************************************/
public class ModeConnectionSaveAsAction extends AbstractAction {
     ...
     *                              listener is designed for
     **************************************************************************/
    public ModeConnectionSaveAsAction(JModeCorrelationPanel correlationPanel,
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (isWritable) {
                fileName = correlationUI_.showConnectionSaveDialog();
                if (fileName != null) {
                    correlationUI_.setConnectionOutput(fileName);
